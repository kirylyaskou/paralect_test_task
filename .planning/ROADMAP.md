...
Plans:
- [ ] 04-01-PLAN.md — Install AI SDK + markdown packages, create OpenRouter provider, DB-to-UIMessage converter, Sonner toast, and 3 API routes (streaming chat, message history, title generation)
...
| 4. Streaming and Core Chat Experience | 0/2 | Not started | - |
